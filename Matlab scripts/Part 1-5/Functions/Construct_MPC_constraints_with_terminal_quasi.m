function [QuasiLPV] = Construct_MPC_constraints_with_terminal_quasi(QuasiLPV)
...
u_low = QuasiLPV.u_low;
u_high = QuasiLPV.u_high;
x_low = QuasiLPV.x_low;
x_high = QuasiLPV.x_high;
N = QuasiLPV.N;
Mn = QuasiLPV.Mn;
bn = QuasiLPV.bn;
